...
of the rash and its cause. 
The training data we need are images of rashes with bounding boxes around them, as well as class labels
(eczema, ringworm, contact dermatitis, etc.)
